                        ...
                        <div>
                            <form className="space-y-6">
                                <div>
                                    <label
                                        htmlFor="username"
                                        className="block text-sm font-medium leading-6 text-text-light dark:text-text-dark"
                                    >
                                        Username
                                    </label>
                                    <div className="mt-2">
                                    ...
                                    <div className="flex items-center">
                                        <p className="text-text-light dark:text-text-dark">
                                            ...
                                            <span
                                                ...
                                                className="font-light text-primary-light dark:text-primary-dark cursor-pointer
                                                hover:text-primary-light/40 dark:hover:text-primary-dark/40 hover:underline "
                                            >
                                                Sign Up
                                            </span>
                                        </p>
                        ...
                        <div className="mt-10">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm font-medium leading-6">
                                    <span className="bg-primary-light dark:bg-primary-dark rounded-md px-6 text-gray-900">
                                        Or continue with
                                    </span>
                                </div>
                            </div>
